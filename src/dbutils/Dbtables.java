...
public  class Dbtables {
    ...
    */ 
    ...
    void canCreatePrivs(ResultSet srcTabPks, String sTableName
        ...
        try {
            ...
            if (sPkname !=null)
                {   
                    ...
                    des.setGrants(sPkname.toString());
    ...
    void canCreatePks(ResultSet srcTabPks, String sTableName
...
public void TodbcanCreateTable(ResultSet srcTabCol, String sSchema, String DbTabLocationType,
            itable Src, itable des) {
...
void canCreateIdx(ResultSet srcTabPks, String sTableName,
        itable Src, itable des
        ) throws Throwable{
        int i = 0;
        tfield a;
        ...
        crap = "tableIndexOther";
             ...
             //   desttable.FieldByName(srcTabPks.getString("COLUMN_NAME"))
                if (srcTabPks.getString("INDEX_NAME") != null) {
                    if (des.Indexes.IndexExists(srcTabPks.getString("INDEX_NAME"))) 
                    {// index exists then get field details from table -- so index is on those fields 
                        a = des
                                .FieldByName(
                                        srcTabPks
...
public boolean isDbtable(String sSchemaName , String sTabName )        
{
 ...
 return isDbtable;
    ...
    void canGetChildTables(ResultSet srcChldTabs, String sTableName, String sToSchema, itable src, itable des
    ) {
        int i = 0;
        ...
        try {
            while (srcChldTabs.next()) {
                ...
                {        
                    ...
                    if (  (t.getType()) != (des.FieldByName(  fk.FkColumn.field.getName()  ).getType())
                       ) 
                    {                 
...
public void getTabDetails(String sFrmSchema, String s2Schema, String sTable) throws SQLException, Throwable{
    ...
    canCreatePrivs(conn1.getMetaData()
    ...
    canCreatePks(conn1.getMetaData().getPrimaryKeys(null, sFrmSchema, sTable)
                        , sTable // tablename
                        , srctable
                        , desttable
                ); 
    ...
    canCreateIdx(conn1.getMetaData().getIndexInfo(null, sFrmSchema, sTable, false, true)
                        , sTable // tablename
                        , srctable
                        , desttable
                );
    
    canGetChildTables(conn1.getMetaData().getImportedKeys(    null
                                                                , sFrmSchema
                                                                , sTable
                                                            )
                        , sTable // tablename 
